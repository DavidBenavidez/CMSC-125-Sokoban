...
{{'w','w','w','w','w','w','w','w','w','x'},{'w','e','e','e','e','s','s','s','w','x'},{'w','e','w','e','w','s','w','s','w','x'},{'w','e','w','e','e','s','s','s','w','x'},{'w','e','b','b','b','e','w','e','w','x'},{'w','e','b','k','b','e','e','e','w','x'},{'w','e','b','b','b','w','w','e','w','x'},{'w','e','e','e','e','e','e','e','w','x'},{'w','w','w','w','w','w','w','w','w','x'},{'x','x','x','x','x','x','x','x','x','x'}},
{{'w','w','w','w','w','w','w','w','w','x'},{'w','e','e','e','e','e','e','e','w','x'},{'w','w','b','b','b','w','e','w','w','x'},{'w','e','b','k','b','e','e','e','w','x'},{'w','e','b','b','b','e','e','e','w','x'},{'w','e','e','e','e','s','s','s','w','x'},{'w','e','w','w','w','s','w','s','w','x'},{'w','e','e','e','e','s','s','s','w','x'},{'w','w','w','w','w','w','w','w','w','x'},{'x','x','x','x','x','x','x','x','x','x'}},
{{'w','w','w','w','w','w','w','w','w','x'},{'w','e','s','s','s','e','s','s','w','x'},{'w','e','w','w','e','e','e','e','w','x'},{'w','e','w','e','e','e','w','e','w','x'},{'w','e','b','b','b','b','b','e','w','x'},{'w','e','b','k','e','e','b','s','w','x'},{'w','e','b','b','b','b','b','s','w','x'},{'w','e','s','s','s','s','s','w','w','x'},{'w','w','w','w','w','w','w','w','w','x'},{'x','x','x','x','x','x','x','x','x','x'}},
{{'w','w','w','w','w','x','x','x','x','x'},{'w','e','e','e','w','w','w','w','w','w'},{'w','e','b','b','w','s','s','e','e','w'},{'w','e','e','b','e','w','s','e','e','w'},{'w','e','b','b','s','s','s','e','w','w'},{'w','e','b','k','w','w','w','e','w','x'},{'w','e','b','b','s','s','w','e','w','x'},{'w','e','e','e','e','e','e','e','w','x'},{'w','w','w','e','e','e','e','e','w','x'},{'w','w','w','w','w','w','w','w','w','x'}},
{{'w','w','w','w','w','w','w','w','w','w'},{'w','s','s','s','s','s','s','s','s','w'},{'w','w','b','b','w','b','b','w','e','w'},{'w','w','e','b','e','e','b','e','e','w'},{'w','e','e','b','w','e','b','w','e','w'},{'w','e','b','k','e','b','e','e','e','w'},{'w','e','b','e','e','b','e','e','e','w'},{'w','e','b','b','w','b','b','w','e','w'},{'w','s','s','s','s','s','s','s','s','w'},{'w','w','w','w','w','w','w','w','w','w'}},
{{'w','w','w','w','w','w','w','x','x','x'},{'w','s','e','e','e','s','w','x','x','x'},{'w','e','b','b','b','e','w','x','x','x'},{'w','e','b','k','b','e','w','x','x','x'},{'w','s','b','b','b','s','w','x','x','x'},{'w','s','s','e','s','s','w','x','x','x'},{'w','w','w','w','w','w','w','x','x','x'},{'x','x','x','x','x','x','x','x','x','x'},{'x','x','x','x','x','x','x','x','x','x'},{'x','x','x','x','x','x','x','x','x','x'}}
};
...
void print_storage(int x, int y){
	...
	// print deco
	write_pixel(x + 4, y + 4, WHITE);
    write_pixel(x + 4, y + 5, WHITE);
    write_pixel(x + 4, y + 6, WHITE);
    write_pixel(x + 5, y + 4, WHITE);
    write_pixel(x + 5, y + 5, WHITE);
    write_pixel(x + 5, y + 6, WHITE);
    write_pixel(x + 6, y + 4, WHITE);
    write_pixel(x + 6, y + 5, WHITE);
    write_pixel(x + 6, y + 6, WHITE);
    write_pixel(x + 4, y + 10, WHITE);
    write_pixel(x + 4, y + 11, WHITE);
    write_pixel(x + 4, y + 12, WHITE);
    write_pixel(x + 5, y + 10, WHITE);
    write_pixel(x + 5, y + 11, WHITE);
    write_pixel(x + 5, y + 12, WHITE);
    write_pixel(x + 6, y + 10, WHITE);
    write_pixel(x + 6, y + 11, WHITE);
    write_pixel(x + 6, y + 12, WHITE);

    write_pixel(x + 10, y + 4, WHITE);
    write_pixel(x + 10, y + 5, WHITE);
    write_pixel(x + 10, y + 6, WHITE);
    write_pixel(x + 11, y + 4, WHITE);
    write_pixel(x + 11, y + 5, WHITE);
    write_pixel(x + 11, y + 6, WHITE);
    write_pixel(x + 12, y + 4, WHITE);
    write_pixel(x + 12, y + 5, WHITE);
    write_pixel(x + 12, y + 6, WHITE);
    write_pixel(x + 10, y + 10, WHITE);
    write_pixel(x + 10, y + 11, WHITE);
    write_pixel(x + 10, y + 12, WHITE);
    write_pixel(x + 11, y + 10, WHITE);
    write_pixel(x + 11, y + 11, WHITE);
    write_pixel(x + 11, y + 12, WHITE);
    write_pixel(x + 12, y + 10, WHITE);
    write_pixel(x + 12, y + 11, WHITE);
    write_pixel(x + 12, y + 12, WHITE);
}
