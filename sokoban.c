...
void print_character(int x, int y){
    ...
    // hoooooman
    write_pixel(x + 3 + 4, y + 2, LIGHT_GREEN);
	write_pixel(x + 3 + 5, y + 2, GREEN);
	write_pixel(x + 3 + 6, y + 2, GREEN);
	write_pixel(x + 3 + 7, y + 2, GREEN);
	write_pixel(x + 3 + 8, y + 2, DARK_GREEN);

	write_pixel(x + 3 + 3, y + 3, LIGHT_GREEN);
	write_pixel(x + 3 + 4, y + 3, GREEN);
	write_pixel(x + 3 + 5, y + 3, GREEN);
	write_pixel(x + 3 + 6, y + 3, DARK_GREEN);
	write_pixel(x + 3 + 7, y + 3, DARK_GREEN);
	write_pixel(x + 3 + 8, y + 3, GREEN);
	write_pixel(x + 3 + 9, y + 3, DARK_GREEN);

	write_pixel(x + 3 + 2, y + 4, LIGHT_GREEN);
	write_pixel(x + 3 + 3, y + 4, GREEN);
	write_pixel(x + 3 + 4, y + 4, DARK_GREEN);
	write_pixel(x + 3 + 5, y + 4, DARK_GREEN);
	write_pixel(x + 3 + 6, y + 4, DARK_YELLOW);
	write_pixel(x + 3 + 7, y + 4, DARK_YELLOW);
	write_pixel(x + 3 + 8, y + 4, DARK_GREEN);
	write_pixel(x + 3 + 9, y + 4, GREEN);
	write_pixel(x + 3 + 10, y + 4, DARK_GREEN);

	write_pixel(x + 3 + 2, y + 5, GREEN);
	write_pixel(x + 3 + 3, y + 5, DARK_GREEN);
	write_pixel(x + 3 + 4, y + 5, PEACH);
	write_pixel(x + 3 + 5, y + 5, PEACH);
	write_pixel(x + 3 + 6, y + 5, YELLOW);
	write_pixel(x + 3 + 7, y + 5, DARK_YELLOW);
	write_pixel(x + 3 + 8, y + 5, DARK_YELLOW);
	write_pixel(x + 3 + 9, y + 5, DARK_GREEN);
	write_pixel(x + 3 + 10, y + 5, GREEN);

	write_pixel(x + 3 + 2, y + 6, DARK_GREEN);
	write_pixel(x + 3 + 3, y + 6, PEACH);
	write_pixel(x + 3 + 4, y + 6, BLACK);
	write_pixel(x + 3 + 5, y + 6, PEACH);
	write_pixel(x + 3 + 6, y + 6, PEACH);
	write_pixel(x + 3 + 7, y + 6, PEACH);
	write_pixel(x + 3 + 8, y + 6, BLACK);
	write_pixel(x + 3 + 9, y + 6, DARK_YELLOW);
	write_pixel(x + 3 + 10, y + 6, DARK_GREEN);

	write_pixel(x + 3 + 2, y + 7, DARK_GREEN);
	write_pixel(x + 3 + 3, y + 7, PEACH);
	write_pixel(x + 3 + 4, y + 7, BLACK);
	write_pixel(x + 3 + 5, y + 7, PEACH);
	write_pixel(x + 3 + 6, y + 7, PEACH);
	write_pixel(x + 3 + 7, y + 7, PEACH);
	write_pixel(x + 3 + 8, y + 7, BLACK);
	write_pixel(x + 3 + 9, y + 7, DARK_PEACH);
	write_pixel(x + 3 + 10, y + 7, DARK_GREEN);    

	write_pixel(x + 3 + 2, y + 8, DARK_GREEN);
	write_pixel(x + 3 + 3, y + 8, PEACH);
	write_pixel(x + 3 + 4, y + 8, PEACH);
	write_pixel(x + 3 + 5, y + 8, PEACH);
	write_pixel(x + 3 + 6, y + 8, PEACH);
	write_pixel(x + 3 + 7, y + 8, PEACH);
	write_pixel(x + 3 + 8, y + 8, PEACH);
	write_pixel(x + 3 + 9, y + 8, DARK_PEACH);
	write_pixel(x + 3 + 10, y + 8, DARK_GREEN);

	write_pixel(x + 3 + 3, y + 9, GREEN);
	write_pixel(x + 3 + 4, y + 9, PEACH);
	write_pixel(x + 3 + 5, y + 9, PEACH);
	write_pixel(x + 3 + 6, y + 9, PEACH);
	write_pixel(x + 3 + 7, y + 9, PEACH);
	write_pixel(x + 3 + 8, y + 9, DARK_PEACH);
	write_pixel(x + 3 + 9, y + 9, GREEN);    

	write_pixel(x + 3 + 2, y + 10, GREEN);
	write_pixel(x + 3 + 3, y + 10, GREEN);
	write_pixel(x + 3 + 4, y + 10, GREEN);
	write_pixel(x + 3 + 5, y + 10, GREEN);
	write_pixel(x + 3 + 6, y + 10, DARK_GREEN);
	write_pixel(x + 3 + 7, y + 10, GREEN);
	write_pixel(x + 3 + 8, y + 10, GREEN);
	write_pixel(x + 3 + 9, y + 10, GREEN);
	write_pixel(x + 3 + 10, y + 10, DARK_GREEN);

	write_pixel(x + 3 + 2, y + 11, GREEN);
	write_pixel(x + 3 + 3, y + 11, GREEN);
	write_pixel(x + 3 + 4, y + 11, DARK_GREEN);
	write_pixel(x + 3 + 5, y + 11, GREEN);
	write_pixel(x + 3 + 6, y + 11, DARK_GREEN);
	write_pixel(x + 3 + 7, y + 11, GREEN);
	write_pixel(x + 3 + 8, y + 11, GREEN);
	write_pixel(x + 3 + 9, y + 11, GREEN);
	write_pixel(x + 3 + 10, y + 11, GREEN);

	write_pixel(x + 3 + 2, y + 12, DARK_GREEN);
	write_pixel(x + 3 + 3, y + 12, GREEN);
	write_pixel(x + 3 + 4, y + 12, GREEN);
	write_pixel(x + 3 + 5, y + 12, GREEN);
	write_pixel(x + 3 + 6, y + 12, DARK_GREEN);
	write_pixel(x + 3 + 7, y + 12, GREEN);
	write_pixel(x + 3 + 8, y + 12, GREEN);
	write_pixel(x + 3 + 9, y + 12, GREEN);
	write_pixel(x + 3 + 10, y + 12, DARK_GREEN);

	write_pixel(x + 3 + 2, y + 13, PEACH);
	write_pixel(x + 3 + 3, y + 13, DARK_GREEN);
	write_pixel(x + 3 + 4, y + 13, GREEN);
	write_pixel(x + 3 + 5, y + 13, GREEN);
	write_pixel(x + 3 + 6, y + 13, DARK_GREEN);
	write_pixel(x + 3 + 7, y + 13, GREEN);
	write_pixel(x + 3 + 8, y + 13, GREEN);
	write_pixel(x + 3 + 9, y + 13, DARK_GREEN);
	write_pixel(x + 3 + 10, y + 13, PEACH);

	write_pixel(x + 3 + 3, y + 14, DARK_GRAY);
	write_pixel(x + 3 + 4, y + 14, PANTS);
	write_pixel(x + 3 + 5, y + 14, PANTS);
	write_pixel(x + 3 + 6, y + 14, DARK_GRAY);
	write_pixel(x + 3 + 7, y + 14, PANTS);
	write_pixel(x + 3 + 8, y + 14, PANTS);
	write_pixel(x + 3 + 9, y + 14, DARK_GRAY);

	write_pixel(x + 3 + 3, y + 15, PANTS);
	write_pixel(x + 3 + 4, y + 15, PANTS);
	write_pixel(x + 3 + 5, y + 15, DARK_GRAY);
	write_pixel(x + 3 + 7, y + 15, PANTS);
	write_pixel(x + 3 + 8, y + 15, PANTS);
	write_pixel(x + 3 + 9, y + 15, DARK_GRAY);
}
...
void print_board(char move){ // self-explanatory
	...
	for(j = 15; j < 185; j+=17){		
		for(k = 25; k < 195; k+=17){	
            ...
            else if(current_level[xPos][yPos] == 'k') print_character(k,j);
			else if(current_level[xPos][yPos] == 'K') print_character_score(k,j);
