...
int i, j, k, l;
char level0[10][10]  = {{'w','w','w','w','w','w','w','w','w','w'},{'w','e','e','e','b','e','e','e','e','w'},{'w','e','k','e','s','e','s','e','e','w'},{'w','e','e','e','e','b','e','e','e','w'},{'w','e','b','e','b','e','e','e','e','w'},{'w','e','e','e','e','e','e','e','e','w'},{'w','e','e','e','e','e','e','e','e','w'},{'w','e','e','e','e','e','e','e','e','w'},{'w','e','e','e','e','e','e','e','e','w'},{'w','w','w','w','w','w','w','w','w','w'}};
...
void print_board(){ // self-explanatory
	...
	for(j = 15; j < 185; j+=17){		
		for(k = 25; k < 195; k+=17){	
            ...
            else if(level[xPos][yPos] == 'k' || level[xPos][yPos] == 'K') print_character(k,j);
            else if(level[xPos][yPos] == 's') print_storage(k,j);
			yPos++;
		}
		yPos = 0;
		xPos++;
